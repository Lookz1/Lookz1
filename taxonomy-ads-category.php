...
<div class="billbord" style="background-image: url('<?php echo get_field('top_block_background_image', $term); ?>');">
    <?php if (get_field('top_block_title', $term)): ?>
        <div class="container">
            <div class="row">
                <div class="col-lg-5 col-md-6">
                    <h1 class="title-big"><?php the_field('top_block_title', $term);?></h1>
                    <p><?php the_field('top_block_subtitle', $term);?></p>
                    <a href="<?php the_field('top_block_link',$term);?>" class="btn-main"><?php the_field('top_block_title_link', $term);?></a>
                </div>
            </div>
        </div>
    <?php endif ?>
...
<div class="featured">
    <div class="container">
        ...
        <div class="bottom-button">
            <a href="<?php the_field('featured_hair_link', $term); ?>" class="btn-main">Sell Your Hair</a>
        </div>
    </div>
</div>
                    ...
                    <a href="<?php echo get_permalink();?>" class="item-catalog item-catalog_featured">
                        ...
                        <span class="item-catalog__content">
                            ...
                            <span class="item-catalog__properties">
                                ...
                                <?php endif ?>
                                <span class="item-catalog__property"><img src="<?php echo get_template_directory_uri() ?>/img/prop2.png" alt="alt"><?php the_date('M d, Y'); ?></span>
...
<div class="calculator">
    <div class="container">
        <div class="row">
            <div class="col-lg-9">
                <div class="title-section"><?php the_field('buy_sell_title',$term);?></div>
                <div class="descr-title"><?php the_field('buy_sell_subtitle',$term);?></div>
                <?php the_field('buy_sell_text',$term);?>
                <div class="text-more">
                    <?php the_field('buy_sell_hidden_text',$term);?>
                </div>
                <?php if (get_field('buy_sell_hidden_text',$term)): ?>
...
<?php if (get_field('how_much_title', $term)): ?>
    <div class="prices">
        <div class="container">
            <div class="title-section"><?php the_field('how_much_title',$term) ?></div>
            <div class="table-wrap">
                <table>
                    ...
                    <tbody>
                        <?php if (get_field('how_much_table',$term)): ?>
                            <?php foreach (get_field('how_much_table',$term) as $how_much_table): ?>
                                <tr>
                                    <td>
